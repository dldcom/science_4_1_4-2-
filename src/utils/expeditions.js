...
export const foodPlanets = [
  {
    ...
    storyboard: [
      {
        image: '/images/yogurt_pixel_1.png',
        text: '와! 행성에 도착하니 달콤하고 새콤한 냄새가 코를 찔러요! 놀랍게도 행성 전체에 하얀 강물이 흐르고 있답니다.'
      },
      {
        image: '/images/yogurt_pixel_2.png',
        text: '우리가 보낸 젖산균들이 우주선에서 흘러나온 우유를 보글보글 발효시켜 놓은 것이었어요.'
      },
      {
        image: '/images/yogurt_pixel_3.png',
        text: '대원들이 떠서 먹어보니 시큼하면서도 기분 좋게 달콤한 맛이 났어요. 대원들은 이 하얗고 신비한 음료를 \'요구르트\'라고 이름 짓고 매일 본국으로 공급하기 시작했습니다!'
      }
    ],
  ...
  },
  {
    ...
    storyboard: [
      {
        image: '/images/bread_pixel_1.png',
        text: '이 성운의 구름들은 만지면 엄청 푹신푹신하고 신기하게도 뜨끈한 온기가 느껴져요.'
      },
      {
        image: '/images/bread_pixel_2.png',
        text: '우리가 보낸 이스트(효모)들이 우주 밀가루 가루를 먹고 이산화탄소를 내뿜어 구름을 크게 부풀린 것이었어요.'
      },
      {
        image: '/images/bread_pixel_3.png',
        text: '구름 조각을 떼어 먹어보니 구수한 풍미와 쫄깃한 식감이 아주 훌륭했답니다. 대원들은 이 부풀어 오른 맛있는 솜뭉치를 \'식빵\'이라고 부르기로 하고, 기지의 주식으로 삼았습니다!'
      }
    ],
